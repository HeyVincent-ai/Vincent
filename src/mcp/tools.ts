...
import {
  ...
  webSearchSchema,
  newsSearchSchema,
} from '../dataSources/brave/handler.js';
import {
  searchTweets,
  searchTweetsSchema,
  getTweet,
...
export const TOOLS: ToolDefinition[] = [
  ...
  },
  {
    ...
    handler: async (args, ctx) =>
      runDataSourceTool(ctx, 'brave', 'web', webSearchSchema, webSearch, args),
  },
  {
    ...
    secretTypes: ['DATA_SOURCES'],
    handler: async (args, ctx) =>
      runDataSourceTool(ctx, 'brave', 'news', newsSearchSchema, newsSearch, args),
  },
  {
    ...
    secretTypes: ['DATA_SOURCES'],
    handler: async (args, ctx) =>
      runDataSourceTool(ctx, 'twitter', 'search', searchTweetsSchema, searchTweets, args),
  },
  {
