      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <button
            ...
            className="text-sm text-primary hover:text-primary/80 mb-2 transition-colors"
          >
            &larr; Back
          </button>
          <h1 className="text-2xl font-bold text-foreground">{secret.memo || 'Unnamed Secret'}</h1>
        </div>
        <button
            ...
            <div>
              <h3
                className={`font-medium ${
                  subStatus.hasMainnetAccess ? 'text-green-400' : 'text-yellow-400'
                }`}
              >
                Mainnet Access
              </h3>
              ...
              <Link
                ...
                className={`text-sm px-3 py-1.5 rounded font-medium transition-colors ${
                  subStatus.hasMainnetAccess
                    ...
                    : 'text-primary-foreground bg-yellow-600 hover:bg-yellow-700'
                }`}
              >
